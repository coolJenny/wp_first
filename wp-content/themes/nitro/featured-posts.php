<?php if ( get_theme_mod('nitro_a_box_enable') && is_front_page() ) : ?>
<div id="featured-posts" class="container">
	<div class="col-md-4 col-sm-4">
	<div class="section-title title-font">
		<?php echo esc_html( get_theme_mod('nitro_a_slider_title',__('Featured Posts','nitro')) ); ?>
	</div>
	    <div class="fposts-container">
	        <div class="swiper-wrapper">
	            <?php
				        $args = array( 
			        	'post_type' => 'post',
			        	'posts_per_page' => esc_html(get_theme_mod('nitro_a_slider_count',10)),
			        	'cat'         => esc_html( get_theme_mod('nitro_a_slider_cat',0) ),
			        	);
				        ...
				        while ( $loop->have_posts() ) : 
				        	...
				        	if ( has_post_thumbnail() ) :
				        		$image_data = wp_get_attachment_image_src( get_post_thumbnail_id( $loop->post->ID), 'nitro-sq-thumb' ); 
	...
	<div class="section-title title-font">
		<?php echo esc_html( get_theme_mod('nitro_a_box_title','Trending') ) ?>
	</div>
	    <div class="featured-grid-container">
	        <div class="fg-wrapper">
	            <?php
			        	...
			        	'post_type' => 'post',
			        	'posts_per_page' => 8, 
			        	'cat'  => esc_html( get_theme_mod('nitro_a_box_cat',0) ),
