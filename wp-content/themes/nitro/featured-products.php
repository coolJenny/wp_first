<?php if ( get_theme_mod('nitro_box_enable') && is_front_page() ) : ?>
<div id="featured-products" class="container">
	<div class="col-md-4 col-sm-4">
	<div class="section-title title-font">
		<?php echo esc_html( get_theme_mod('nitro_slider_title',__('Featured Products','nitro')) ); ?>
	</div>
	    <div class="fp-container">
	        <div class="swiper-wrapper">
	            <?php
				        $args = array( 
			        	'post_type' => 'product',
			        	'posts_per_page' => get_theme_mod('nitro_slider_count',10),
			        	'tax_query' => array(
								         array(
								            'taxonomy'      => 'product_cat',
								            'terms'         => esc_html( get_theme_mod('nitro_slider_cat',0) ),
	...
	<div class="section-title title-font">
		<?php echo esc_html( get_theme_mod('nitro_box_title','Trending') ) ?>
	</div>
	        ...
	        <div class="fg-wrapper">
	            <?php
			        	...
			        	'tax_query' => array(
								         array(
								            'taxonomy'      => 'product_cat',
								            'terms'         => esc_html( get_theme_mod('nitro_box_cat',0) ),
								            'operator'      => 'IN' // Possible values are 'IN', 'NOT IN', 'AND'.
								         )
									)
						);
